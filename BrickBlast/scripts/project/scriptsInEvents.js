...
script.setAttribute('data-jg-packagename', 'com.7SeasEntertainmentLimited.BrickBlastSP');
...
const scriptsInEvents = {
	...
	async Generalevent_Event80_Act7(runtime, localVars)
	{
		showRewardedAd();
	},

	async Generalevent_Event81_Act7(runtime, localVars)
	{
